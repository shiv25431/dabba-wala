...
function AdminPanel() {
  ...
  const openQuickPlan = (meal) => { setPlanMeal(meal); setPlanDate(quickDateFor(meal)); setPlanSearch(""); setTimeout(()=>document.getElementById("dw-planning")?.scrollIntoView({behavior:"smooth"}),50); };
  ...
  return <div className="dw-admin-page">
    <aside className="dw-sidebar">
      ...
      <nav className="dw-side-nav">
        ...
        <button onClick={()=>document.getElementById("dw-planning")?.scrollIntoView({behavior:"smooth"})}>✓ <span>Meal Planning</span></button>
        <button onClick={()=>document.getElementById("dw-quick-daily")?.scrollIntoView({behavior:"smooth"})}>▣ <span>Daily Delivery</span></button>
    ...
    <div className="dw-dashboard-shell">
      ...
      <main className="dw-admin-wrap" id="dw-dashboard">
        ...
        <section className="dw-admin-card dw-planning-card" id="dw-planning">
        ...
        <section className="dw-admin-card dw-quick-daily-card" id="dw-quick-daily">
    ...
    <style>{`
      ...
      @media(max-width:700px){.dw-plan-toolbar{grid-template-columns:1fr 1fr}.dw-plan-search{grid-column:1/-1}.dw-bulk-row{align-items:flex-start;flex-direction:column}.dw-bulk-meal{width:100%;justify-content:space-between}}
